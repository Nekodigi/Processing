PVector vecFromUVW(float u, float v, float w, PVector bx, PVector by, PVector bz){
  return PVector.add(PVector.mult(bx, u), PVector.mult(by, v)).add(PVector.mult(bz, w));
}
